 ...
 */
public class FortsMessageReader extends MessageReader {

    public FortsMessageReader(ConnectionId connectionId, ConfigurationManager configurationManager, MarketDataManager marketDataManager, MicexInstrumentManager instumentManager) {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        ConfigurationManager configurationManager = new FortsConfigurationManager().configure(new FortsNullGatewayConfiguration() {
            @Override
        ...
        final FortsMessageReader messageReader = new FortsMessageReader(ConnectionId.convert(args[0]), configurationManager, null, null);
