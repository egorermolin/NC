...
public enum ConnectionId {
    ...
    FUT_STATISTICS_SNAP_A("FUT-BOOK-1-S-A"),
    FUT_STATISTICS_SNAP_B("FUT-BOOK-1-S-B"),
    FUT_STATISTICS_INCR_A("FUT-BOOK-1-I-A"),
    FUT_STATISTICS_INCR_B("FUT-BOOK-1-I-B"),
    FUT_PUB_TRADES_SNAP_A("FUT-TRADES-S-A"),
    FUT_PUB_TRADES_SNAP_B("FUT-TRADES-S-B"),
    FUT_PUB_TRADES_INCR_A("FUT-TRADES-I-A"),
    FUT_PUB_TRADES_INCR_B("FUT-TRADES-I-B");
