...
public class MicexCodecTest {
    ...
    public void setup() throws IOException {
        ...
        when(configurationManager.getPrimaryNetworkInterface(false)).thenReturn("127.0.0.1");
        when(configurationManager.getSecondaryNetworkInterface(false)).thenReturn("127.0.0.1");
